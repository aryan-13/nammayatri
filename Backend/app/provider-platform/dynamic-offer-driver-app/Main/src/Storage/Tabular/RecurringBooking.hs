...
import qualified Storage.Tabular.RiderDetails as SRider
...
instance TType RecurringBookingT Domain.SimpleRecurringBooking where
...
instance TType FullRecurringBookingT Domain.RecurringBooking where
